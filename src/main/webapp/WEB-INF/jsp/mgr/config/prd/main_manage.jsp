	...
	<div class="container-fluid  mt--6">
		<div class="card">
			<div class="card-header border-0 d-flex">	 
				<h3 class="mb-0">메인 상품 생성 코드</h3>       
				<button type="button" onclick="javascript:copyClipboard('#codeMain');" class="btn btn-light btn-sm ml-auto">생성코드복사</button>
			</div>
			<div class="card-body">
...
&lt;/jsp:include&gt;
		...
		<div class="card">
			<div class="card-header border-0 d-flex">	 
				...
				<a href="./main_write.do" class="btn btn-primary ml-auto">메인게시물 생성</a>
			</div>
			<div class="card-body">
...
<c:forEach var="m" items="${list }" varStatus="s">
	...
	<c:if test="${m.listType eq 'C' }">
		<c:set var="listType" value="메인 노출"/>
									...
									<td>
<span id="spanCode_${m.rpSeq }" class="pl10 pr10 d-none">
&lt;jsp:include page="/module/rp.do" flush="true"&gt;
	&lt;jsp:param name="rpseq" value="${m.rpSeq }" /&gt;
&lt;/jsp:include&gt;
										</span>
										<a href="javascript:copyClipboard('#spanCode_${m.rpSeq }');" class="btn btn-sm btn-light">생성코드복사</a>
										<a href="javascript:openPop('?rpseq=${m.rpSeq }', 'previewRecentPrd');" class="btn btn-sm btn-primary">미리보기</a>
										<a href="javascript:$.Nav('go', './main_write.do', {rpseq: '${m.rpSeq }'});" class="btn btn-sm btn-primary">수정</a>
										<a href="javascript:deleteSubmit(${m.rpSeq})" class="btn btn-sm btn-danger">삭제</a>
									</td>
								</tr>
</c:forEach>
