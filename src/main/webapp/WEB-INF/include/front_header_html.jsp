				...
				<ul class="gnb">
					<li>
						...
						<dl class="sm" style="border-right:1px solid #CCC;">
							<dd class="frt"><a href="/pages/customer/normal.jsp">normal</a></dd>
							<dd><a href="/pages/customer/bulletin.jsp">bulletin</a></dd>
							<dd><a href="/pages/customer/answer.jsp">answer</a></dd>
							<dd><a href="/pages/customer/faqBoard.jsp">faqBoard</a></dd>
							<dd><a href="/pages/customer/imageBoard.jsp">imageBoard</a></dd>
							<dd><a href="/pages/customer/orderBoard.jsp">orderBoard</a></dd>
							<dd><a href="/pages/customer/thumbnail.jsp">thumbnail</a></dd>
						</dl>
					</li>
					<li>
					...
					<!-- <li>
						...
						<dl class="sm" style="border-right:1px solid #CCC;">
							...
							<dd><a href="/pages/customer/testpage.jsp">FAQ</a></dd>
						</dl>
					</li> -->
				</ul>
			</div>
