...
public class BoardServiceImpl extends BaseServiceImpl implements BoardService {
	 ...
	 * @throws Exception
	 */
	public int deleteBoardMaster(BoardSearchVO search, BoardMasterVO vo) throws Exception {
		
		getDAO().update("frontMenu.deleteByKey",search.getBcode());
		return getDAO().delete("boardMaster.deleteByKey", search.getBcode());
	}
