...
public class DashBoardServiceImpl extends BaseServiceImpl {
	...
	@SuppressWarnings("unchecked") 
  public List<?> getDashBoardHistoryHitListLastMonth() throws Exception {
    List<HistoryHitVO> list = (List<HistoryHitVO>) super.getDAO().selectList("historyHit.selectLastMonth", new HistoryHitVO());
    return list;
  }
