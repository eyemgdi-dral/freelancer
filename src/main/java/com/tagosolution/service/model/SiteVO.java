...
public class SiteVO implements GeneralModel {
	...
	private String logoImageHead;
	
	private String logoImageFoot;
	...
	public String getLogoImageHead() {
		return logoImageHead;
	}

	public void setLogoImageHead(String logoImageHead) {
		this.logoImageHead = logoImageHead;
	}

	public String getLogoImageFoot() {
		return logoImageFoot;
	}

	public void setLogoImageFoot(String logoImageFoot) {
		this.logoImageFoot = logoImageFoot;
	}

	public List<MultipartFile> getUploadFile() {
		if (this.uploadFile == null)
			this.uploadFile = new ArrayList<MultipartFile>();
		return uploadFile;
	}
	...
	public SiteApiVO getSiteApiVO() {
		return siteApiVO;
	}

	public void setSiteApiVO(SiteApiVO siteApiVO) {
		this.siteApiVO = siteApiVO;
	}
