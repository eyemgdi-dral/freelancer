...
public class BoardMasterVO implements GeneralModel {
	...
	private Short imageSizeWidth;
	
	private Short imageSizeHeight;
	...
	private Integer pointMaxDay;
	
	private Integer pointMaxMember;
	...
	public Short getimageSizeWidth() {
		return imageSizeWidth;
	}
	
	public void setimageSizeWidth(Short imageSizeWidth) {
		this.imageSizeWidth = imageSizeWidth;
	}
	
	public Short getimageSizeHeight() {
		return imageSizeHeight;
	}
	
	public void setimageSizeHeight(Short imageSizeHeight) {
	...
	public Integer getPointMaxDay() {
		return pointMaxDay;
	}

	public void setPointMaxDay(Integer pointMaxDay) {
		this.pointMaxDay = pointMaxDay;
	}

	public Integer getPointMaxMember() {
		return pointMaxMember;
	}

	public void setPointMaxMember(Integer pointMaxMember) {
		this.pointMaxMember = pointMaxMember;
	}
