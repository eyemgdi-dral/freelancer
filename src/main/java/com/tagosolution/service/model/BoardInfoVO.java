...
public class BoardInfoVO implements GeneralModel {
	...
	private Boolean regUserIsAdmin;
	//첨부 파일 또는 이미지 파일
	...
	public Boolean getRegUserIsAdmin() {
		return regUserIsAdmin;
	}

	public void setRegUserIsAdmin(Boolean regUserIsAdmin) {
		this.regUserIsAdmin = regUserIsAdmin;
	}
