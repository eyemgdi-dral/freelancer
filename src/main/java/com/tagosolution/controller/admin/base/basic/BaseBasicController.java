...
public class BaseBasicController extends BaseController {
	...
	public String siteInfo(SearchVO search, BindingResult result, Model model, HttpServletRequest request) throws Exception {
		super.setPageSubTitle("기본 설정 &gt; 사이트 정보", model);
		
		if(result.hasErrors())
			return super.setBindingResult(result, model);
		SiteVO vo = _siteService.getCurrentSiteInfo(request);
