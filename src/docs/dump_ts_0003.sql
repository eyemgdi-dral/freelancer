...
-- Dumping database structure for ts_0003
CREATE DATABASE IF NOT EXISTS `ts_0003` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ts_0003`;

-- Dumping structure for function ts_0003.GET_CODE_NAME
...
-- Dumping structure for function ts_0003.GET_USER_NAME
...
-- Dumping structure for table ts_0003.hibernate_sequence
DROP TABLE IF EXISTS `hibernate_sequence`;
CREATE TABLE IF NOT EXISTS `hibernate_sequence` (
  `next_val` bigint(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Dumping data for table ts_0003.hibernate_sequence: 2 rows
...
-- Dumping structure for table ts_0003.ts_admin
...
-- Dumping data for table ts_0003.ts_admin: ~5 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_banner_info
...
-- Dumping data for table ts_0003.ts_banner_info: ~11 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_banner_master
...
-- Dumping data for table ts_0003.ts_banner_master: ~4 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_base_cmomey
...
-- Dumping data for table ts_0003.ts_base_cmomey: ~0 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_board_category
...
-- Dumping data for table ts_0003.ts_board_category: ~6 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_board_info
...
-- Dumping data for table ts_0003.ts_board_info: ~57 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_board_master
...
-- Dumping data for table ts_0003.ts_board_master: ~11 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_board_status
...
-- Dumping data for table ts_0003.ts_board_status: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_board_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_board_status` ENABLE KEYS */;

-- Dumping structure for table ts_0003.ts_clause
...
-- Dumping data for table ts_0003.ts_clause: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_clause` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_clause` ENABLE KEYS */;

-- Dumping structure for table ts_0003.ts_comment
...
-- Dumping data for table ts_0003.ts_comment: ~67 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_comm_contents
...
-- Dumping data for table ts_0003.ts_comm_contents: ~9 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_comm_group
...
-- Dumping data for table ts_0003.ts_comm_group: ~3 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_file
...
-- Dumping data for table ts_0003.ts_file: ~30 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_fixed_code
...
-- Dumping data for table ts_0003.ts_fixed_code: ~42 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_form
...
-- Dumping data for table ts_0003.ts_form: ~3 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_form_info
...
-- Dumping data for table ts_0003.ts_form_info: ~15 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_form_value
...
-- Dumping data for table ts_0003.ts_form_value: ~39 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_form_writing
...
-- Dumping data for table ts_0003.ts_form_writing: ~3 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_group
...
-- Dumping data for table ts_0003.ts_group: ~6 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_history_hit
...
-- Dumping data for table ts_0003.ts_history_hit: ~180 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_history_host
...
-- Dumping data for table ts_0003.ts_history_host: ~150 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_history_login
...
-- Dumping data for table ts_0003.ts_history_login: ~21 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_mail_tmpl
...
-- Dumping data for table ts_0003.ts_mail_tmpl: ~2 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_member_cmomey
...
-- Dumping data for table ts_0003.ts_member_cmomey: ~25 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_member_company
...
-- Dumping data for table ts_0003.ts_member_company: ~8 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_member_grade
...
-- Dumping data for table ts_0003.ts_member_grade: ~3 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_member_info
...
-- Dumping data for table ts_0003.ts_member_info: ~21 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_member_setting
...
-- Dumping data for table ts_0003.ts_member_setting: ~0 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_menu
...
-- Dumping data for table ts_0003.ts_menu: ~70 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_menu_autho
...
-- Dumping data for table ts_0003.ts_menu_autho: ~123 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_menu_auth_group
...
-- Dumping data for table ts_0003.ts_menu_auth_group: ~4 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_page
...
-- Dumping data for table ts_0003.ts_page: ~12 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_popup
...
-- Dumping data for table ts_0003.ts_popup: ~0 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_prd
...
-- Dumping data for table ts_0003.ts_prd: ~16 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_prd_category
...
-- Dumping data for table ts_0003.ts_prd_category: ~8 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_prd_image
...
-- Dumping data for table ts_0003.ts_prd_image: ~14 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_prd_sub
...
-- Dumping data for table ts_0003.ts_prd_sub: ~0 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_quick_consultation
...
-- Dumping data for table ts_0003.ts_quick_consultation: ~9 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_recent_board
...
-- Dumping data for table ts_0003.ts_recent_board: ~3 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_recent_prd
...
-- Dumping data for table ts_0003.ts_recent_prd: ~2 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_site
...
-- Dumping data for table ts_0003.ts_site: ~0 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_site_api
...
-- Dumping data for table ts_0003.ts_site_api: ~0 rows (approximately)
...
-- Dumping structure for table ts_0003.ts_site_meta
...
-- Dumping data for table ts_0003.ts_site_meta: ~6 rows (approximately)
