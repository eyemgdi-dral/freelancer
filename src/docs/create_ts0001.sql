...
-- Dumping database structure for ts_0001
DROP DATABASE IF EXISTS `ts_0001`;
CREATE DATABASE IF NOT EXISTS `ts_0001` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ts_0001`;

-- Dumping structure for function ts_0001.GET_CODE_NAME
...
-- Dumping structure for function ts_0001.GET_USER_NAME
...
-- Dumping structure for table ts_0001.hibernate_sequence
DROP TABLE IF EXISTS `hibernate_sequence`;
CREATE TABLE IF NOT EXISTS `hibernate_sequence` (
  `next_val` bigint(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Dumping data for table ts_0001.hibernate_sequence: 2 rows
...
-- Dumping structure for table ts_0001.ts_admin
...
-- Dumping data for table ts_0001.ts_admin: ~4 rows (approximately)
...
INSERT INTO `ts_admin` (`ADMIN_ID`, `ADMIN_PWD`, `ADMIN_NAME`, `NICKNAME`, `ICON`, `EMAIL`, `PHONE`, `MOBILE`, `MEMO`, `AUTHS`, `REG_DATE`, `MOD_DATE`, `USE_YN`) VALUES
	...
	('bronze', 'A6xnQhbz4Vx2HuGl4lXwZ5U2I8iziLRFnhP5eNfIRvQ', 'baaal', NULL, '/image/admin/20180921154009683001.jpg', 'bal@g.com', '', '', '', NULL, '2018-09-21 15:38:57', '2018-10-23 11:49:11', 'Y'),
...
-- Dumping structure for table ts_0001.ts_banner_info
...
-- Dumping data for table ts_0001.ts_banner_info: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_banner_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_banner_info` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_banner_master
...
-- Dumping data for table ts_0001.ts_banner_master: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_banner_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_banner_master` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_board_category
...
-- Dumping data for table ts_0001.ts_board_category: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_board_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_board_category` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_board_info
...
-- Dumping data for table ts_0001.ts_board_info: ~8 rows (approximately)
...
-- Dumping structure for table ts_0001.ts_board_master
...
-- Dumping data for table ts_0001.ts_board_master: ~3 rows (approximately)
...
-- Dumping structure for table ts_0001.ts_board_status
...
-- Dumping data for table ts_0001.ts_board_status: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_board_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_board_status` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_clause
...
-- Dumping data for table ts_0001.ts_clause: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_clause` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_clause` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_comment
...
-- Dumping data for table ts_0001.ts_comment: ~31 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `ts_comm_contents` (
  `IDX` int(11) NOT NULL COMMENT '자동증가순번',
  `SITE_SEQ` int(11) NOT NULL COMMENT '약관명',
  `C_TYPE` char(1) NOT NULL,
  `TB_NAME` varchar(20) NOT NULL,
  `TB_IDX` int(11) NOT NULL,
  ...
  `MOD_DATE` datetime DEFAULT NULL COMMENT '수정일',
  PRIMARY KEY (`IDX`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='약관 테이블	';

-- Dumping data for table ts_0001.ts_comm_contents: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_comm_contents` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_comm_contents` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_comm_file
DROP TABLE IF EXISTS `ts_comm_file`;
CREATE TABLE IF NOT EXISTS `ts_comm_file` (
  `IDX` int(11) NOT NULL AUTO_INCREMENT COMMENT '코드Type',
  `SITE_SEQ` int(11) NOT NULL COMMENT '사이트순번',
  `TB_NAME` varchar(20) DEFAULT NULL COMMENT '테이블명',
  `TB_IDX` int(11) DEFAULT NULL COMMENT '테이블 키',
  `FILE_TYPE` char(1) DEFAULT NULL COMMENT '파일 유형  (I: 이미지, M: 동영상, N: 일반 첨부파일)',
  `SORT_NUM` smallint(6) DEFAULT NULL COMMENT '순서 (입력 시 TbName, TbIdx를 찾아서 Max(IsNull(SortNum), 0) + 1 처리)',
  ...
  `MOD_DATE` datetime DEFAULT NULL COMMENT '수정일',
  PRIMARY KEY (`IDX`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='첨부파일을 한 곳에서 관리	';

-- Dumping data for table ts_0001.ts_comm_file: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_comm_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_comm_file` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `ts_comm_group` (
  ...
  `SITE_SEQ` int(11) NOT NULL COMMENT '사이트순번',
  `GROUP_DIV` varchar(20) NOT NULL COMMENT '컨텐츠 유형 Content Type',
  ...
  `SORT_NUM` smallint(6) NOT NULL COMMENT '글의 순서',
  `USE_FLAG` char(10) NOT NULL COMMENT '사용유무(U: 사용, S:미사용, D:삭제)',
  `REG_USER` varchar(20) NOT NULL COMMENT '등록자ID',
  `REG_DATE` datetime NOT NULL COMMENT '등록일',
  `MOD_USER` varchar(20) DEFAULT NULL COMMENT '수정자ID',
  `MOD_DATE` datetime DEFAULT NULL COMMENT '수정일',
  PRIMARY KEY (`IDX`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='게시물, 약관 내용이 큰 컨텐츠의 내용을 한곳에서 관리	';

-- Dumping data for table ts_0001.ts_comm_group: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_comm_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_comm_group` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_file
...
-- Dumping data for table ts_0001.ts_file: ~7 rows (approximately)
...
-- Dumping structure for table ts_0001.ts_fixed_code
...
-- Dumping data for table ts_0001.ts_fixed_code: ~42 rows (approximately)
...
-- Dumping structure for table ts_0001.ts_form
...
-- Dumping data for table ts_0001.ts_form: ~1 rows (approximately)
...
-- Dumping structure for table ts_0001.ts_form_info
...
-- Dumping data for table ts_0001.ts_form_info: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_form_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_form_info` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_form_value
...
-- Dumping data for table ts_0001.ts_form_value: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_form_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_form_value` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_form_writing
...
-- Dumping data for table ts_0001.ts_form_writing: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_form_writing` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_form_writing` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_group
...
-- Dumping data for table ts_0001.ts_group: ~2 rows (approximately)
...
-- Dumping structure for table ts_0001.ts_mail_tmpl
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='회원 메일 설정';

-- Dumping data for table ts_0001.ts_mail_tmpl: ~1 rows (approximately)
...
INSERT INTO `ts_mail_tmpl` (`MAIL_SEQ`, `MAIL_NAME`, `ADMIN_SEND_YN`, `USER_SEND_YN`, `BODY`, `SUBJECT`) VALUES
	(1, 'this is test', '', 'Y', 'etestset123123', 'my mail');
/*!40000 ALTER TABLE `ts_mail_tmpl` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_member_grade
...
-- Dumping data for table ts_0001.ts_member_grade: ~3 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=3010 DEFAULT CHARSET=utf8 COMMENT='회원 정보\r\n - 모델, 매퍼 구성';

-- Dumping data for table ts_0001.ts_member_info: ~5 rows (approximately)
...
INSERT INTO `ts_member_info` (`MEMBER_SEQ`, `USER_ID`, `GRADE_LEVEL`, `USER_PWD`, `PWD_CHANGE_DATE`, `USER_NAME`, `PHOTO`, `ICON`, `NICKNAME`, `VIRTUAL_NUMBER`, `EMAIL`, `PHONE`, `MOBILE`, `COMP_PHONE`, `HOMEPAGE`, `ZIPCODE`, `ADDR1`, `ADDR2`, `EMAIL_YN`, `SMS_YN`, `BIRTH_DT`, `IS_LUNAR`, `RECOMM_USER_ID`, `LOGIN_COUNT`, `RECENT_LOGIN_DATE`, `MEMO`, `MEMO_ADMIN`, `REG_DATE`, `USE_YN`, `WITHDRAWAL_YN`, `WITHDRAWAL_REASON`, `WITHDRAWAL_DT`) VALUES
	(3001, 'skyline', 3, 'A6xnQhbz4Vx2HuGl4lXwZ5U2I8iziLRFnhP5eNfIRvQ', '2018-09-21 16:08:18', 'Tenger', NULL, NULL, '', '', 'skyline.mn12@gmail.com', '', '', '', '', '46702', '부산 강서구 대저로235번길 9 (대저1동)', '', 'Y', 'Y', '', NULL, '', 0, NULL, '', '', '2018-09-20 15:39:03', 'Y', 'N', NULL, '2018-10-23'),
	...
	(3007, 'Boss', 4, 'A6xnQhbz4Vx2HuGl4lXwZ5U2I8iziLRFnhP5eNfIRvQ', NULL, 'admin', NULL, NULL, 'sky', 'VITS213', 'skyline.mn12@gmail.com', '010-9999-9999', '010-8888-8888', '7799655', 'www.gooog.com', '06061', '서울 강남구 학동로45길 3-4', 'sick boy', 'Y', 'Y', '1994-10-05', NULL, 'recom', 0, NULL, 'well good noe', '', '2018-10-23 10:50:35', 'Y', 'N', NULL, '2018-10-23');
...
INSERT INTO `ts_member_setting` (`SITE_SEQ`, `NAVER_API`, `NAVER_KEY`, `GOOGLE_API`, `GOOGLE_KEY`, `KAKAO_API`, `KAKAO_KEY`, `FACEBOOK_API`, `FACEBOOK_KEY`, `ID_FLAG`, `PASSWORD_FLAG`, `NAME_FLAG`, `EMAIL_FLAG`, `JUMIN_FLAG`, `ADDR_FLAG`, `PHONE_FLAG`, `MOBILETEL_FLAG`, `COMPHONE_FLAG`, `FAX_FLAG`, `RECOMMEND_FLAG`, `EMAILRECEIVE_FLAG`, `SMSRECEIVE_FLAG`, `NICKNAME_FLAG`, `ICON_FLAG`, `PHOTO_FLAG`, `HOMEPAGE_FLAG`, `BIRTHDAY_FLAG`, `JOB_FLAG`, `JOB_TYPE`, `INTEREST_FLAG`, `INTEREST_TYPE`, `HOBBY_FLAG`, `EDUCATION_FLAG`, `EDUCATION_TYPE`, `SELFINTRO_FLAG`, `MARRIAGE_FLAG`, `MARRIAGEDATE_FLAG`, `INCOME_FLAG`, `INCOME_TYPE`, `CAR_FLAG`, `ETC1_FLAG`, `ETC2_FLAG`, `ETC3_FLAG`, `ETC4_FLAG`, `ETC5_FLAG`, `ETC1_NAME`, `ETC1_TYPE`, `ETC1_SIZE`, `ETC1_COUNT`, `ETC2_NAME`, `ETC2_TYPE`, `ETC2_SIZE`, `ETC2_COUNT`, `ETC3_NAME`, `ETC3_TYPE`, `ETC3_SIZE`, `ETC3_COUNT`, `ETC4_NAME`, `ETC4_TYPE`, `ETC4_SIZE`, `ETC4_COUNT`, `ETC5_NAME`, `ETC5_TYPE`, `ETC5_SIZE`, `ETC5_COUNT`) VALUES
	(1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', '1', '1', '1', '1', '1', '2', '2', '1', '1', '1', '1', '1', '2', '1', '1', '1', '1', '1', 'job', '1', 'interest', '1', '1', 'edu', '1', '1', '1', '1', 'income', '1', '1', '1', '2', '1', '2', 'test', 'text', 1, 1, '2', 'text', 2, 1, '3', 'text', 3, 1, '4', 'text', 4, 1, '5', 'text', 5, 1);
...
CREATE TABLE IF NOT EXISTS `ts_menu` (
  ...
  `PARENT_ID` varchar(5) DEFAULT NULL COMMENT '	부모 메뉴의 ID	',
...
-- Dumping data for table ts_0001.ts_menu: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `ts_menu_autho` (
  `MENU_AUTHO_GROUP_IDX` int(11) NOT NULL COMMENT '관리자 권한 그룹 테이블 순번',
  `SITE_SEQ` int(11) NOT NULL COMMENT '사이트 순번',
  `GROUP_ID` varchar(10) NOT NULL COMMENT '메뉴 테이블의 그룹 ID',
  `MENU_ID` char(5) NOT NULL COMMENT '메뉴ID',
...
-- Dumping data for table ts_0001.ts_menu_autho: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `ts_menu_auth_group` (
  ...
  `MOD_DATE` datetime DEFAULT NULL COMMENT '	수정일	',
  PRIMARY KEY (`IDX`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='	관리자 권한 그룹 테이블	';

-- Dumping data for table ts_0001.ts_menu_auth_group: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_menu_auth_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_menu_auth_group` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_page
...
-- Dumping data for table ts_0001.ts_page: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_page` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_page` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_popup
...
-- Dumping data for table ts_0001.ts_popup: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_popup` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_popup` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_prd
...
-- Dumping data for table ts_0001.ts_prd: ~0 rows (approximately)
...
-- Dumping data for table ts_0001.ts_prd_category: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_prd_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_prd_category` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_prd_image
...
-- Dumping data for table ts_0001.ts_prd_image: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_prd_image` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_prd_image` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_prd_sub
...
-- Dumping data for table ts_0001.ts_prd_sub: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_prd_sub` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_prd_sub` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_recent_board
...
-- Dumping data for table ts_0001.ts_recent_board: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_recent_board` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_recent_board` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_recent_prd
...
-- Dumping data for table ts_0001.ts_recent_prd: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_recent_prd` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_recent_prd` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_site
...
-- Dumping data for table ts_0001.ts_site: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `ts_site_api` (
  `SITE_SEQ` int(11) NOT NULL AUTO_INCREMENT COMMENT '사이트 순번',
  `MAP_TYPE` varchar(10) NOT NULL DEFAULT '0' COMMENT '지도 구분(naver, google, daum)',
  `MAP_KEY` varchar(1000) NOT NULL DEFAULT '0' COMMENT '지도에 키를 사용하면 입력',
  `EDITOR_TYPE` varchar(10) NOT NULL DEFAULT '0' COMMENT 'Editor 구분(CKEditor, naver)',
  `EDITOR_KEY` varchar(1000) NOT NULL DEFAULT '0' COMMENT 'Editor 키(있는 경우에 사용)',
  `UPLOAD_TYPE` varchar(10) NOT NULL DEFAULT '0' COMMENT 'upload 유형',
  `UPLOAD_KEY` varchar(1000) NOT NULL DEFAULT '0' COMMENT 'upload key(있는 경우에 사용)',
  `NAVER_LOG_ID` varchar(100) NOT NULL DEFAULT '0' COMMENT 'naver 로그분석 ID',
  `NAVER_LOG_VALUE` varchar(1000) NOT NULL DEFAULT '0' COMMENT 'naver 로그분석 전환값',
  `GOOGLE_LOG_ID` varchar(100) NOT NULL DEFAULT '0' COMMENT 'Google Analytics ID',
  `GOOGLE_LOG_VALUE` varchar(1000) NOT NULL DEFAULT '0' COMMENT 'naver 로그분석 전환값(필요한 경우에 사용)',
  `PHONE_CHECK_ID` varchar(20) NOT NULL DEFAULT '0' COMMENT '본인인증코드(ID)',
  `PHONE_CHECK_PW` varchar(20) NOT NULL DEFAULT '0' COMMENT '본인인증 비밀번호',
  `IPIN_ID` varchar(20) NOT NULL DEFAULT '0' COMMENT 'IPIN인증 코드(ID)',
  `IPIN_PW` varchar(20) NOT NULL DEFAULT '0' COMMENT 'IPIN인증 비밀번호',
  `FACEBOOK_KEY` varchar(1000) NOT NULL DEFAULT '0' COMMENT '페이스북 사용키(있는 경우에 사용)',
  `TWITTER_KEY` varchar(1000) NOT NULL DEFAULT '0' COMMENT '트위터 사용키(있는 경우에 사용)',
  `KAKAO_KEY` varchar(1000) NOT NULL DEFAULT '0' COMMENT '카카오스토리 사용키(있는 경우에 사용)',
  `NAVER_KEY` varchar(1000) NOT NULL DEFAULT '0' COMMENT '네이버 블로그 사용키(있는 경우에 사용)',
  PRIMARY KEY (`SITE_SEQ`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='사이트 테이블';

-- Dumping data for table ts_0001.ts_site_api: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_site_api` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_site_api` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_site_info
DROP TABLE IF EXISTS `ts_site_info`;
CREATE TABLE IF NOT EXISTS `ts_site_info` (
  `SITE_SEQ` int(11) NOT NULL COMMENT '	사이트 순번  TS_SITE 테이블의 SITE_SEQ	',
  `SITE_ID` varchar(20) DEFAULT NULL COMMENT '	사이트ID	',
  `SITE_NAME` varchar(30) DEFAULT NULL COMMENT '	사이트명	',
  `SITE_URL` varchar(40) DEFAULT NULL COMMENT '	사이트도메인	',
  `USE_FLAG` char(1) NOT NULL COMMENT '	사용유무(U: 사용, S:미사용, D:삭제)	',
  `REG_USER` varchar(20) NOT NULL COMMENT '	등록자ID	',
  `REG_DATE` datetime NOT NULL COMMENT '	등록일	',
  `MOD_USER` varchar(20) DEFAULT NULL COMMENT '	수정자ID	',
...
-- Dumping data for table ts_0001.ts_site_info: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_site_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_site_info` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `ts_site_meta` (
  `IDX` int(11) NOT NULL AUTO_INCREMENT COMMENT '코드Type',
  `SITE_SEQ` int(11) NOT NULL COMMENT '사이트순번',
  `GROUP_IDX` int(11) NOT NULL COMMENT '그룹순번',
  ...
  `MOD_DATE` datetime DEFAULT NULL COMMENT '수정일',
  PRIMARY KEY (`IDX`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='사이트의 메타태그	';

-- Dumping data for table ts_0001.ts_site_meta: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_site_meta` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_site_meta` ENABLE KEYS */;

-- Dumping structure for table ts_0001.ts_terms
...
-- Dumping data for table ts_0001.ts_terms: ~0 rows (approximately)
/*!40000 ALTER TABLE `ts_terms` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_terms` ENABLE KEYS */;

-- Dumping structure for view ts_0001.vw_cate
...
-- Dumping structure for trigger ts_0001.TR_TS_PRD_CATEGORY_AFTER_DELETE
